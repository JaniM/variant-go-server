/// This is stolen quite directly from `yewtil`. It currently (as of 0.17.3)
/// doesn't provide quite the API I want here and adding it all is a major
/// breaking change, so copy and fix it is.
...
pub type StoreBridge<S> = Box<dyn Bridge<StoreWrapper<S>>>;
